    ...
    const fetchHiredFreelancers = async () => {
      try {
        ...
        const freelancers = res.data.map((contract) => ({
          ...
          total_earnings: contract.collaborator.total_earnings || 0, // ✅ ADD THIS
    ...
    <div className="w-full min-h-screen bg-[#F5F5F5]">
      ...
      "
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.skills.slice(0, 4).map((tag, i) => (
                        <span
                          key={i}
                          className="
        bg-[#6B4FA3]
                    ...
                    <div className="flex items-center justify-between pt-5 border-t text-[13px] text-gray-400">
                      <div className="flex items-center gap-3 text-[13px] text-gray-500">
                        ...
                        <span className="flex items-center gap-1">
                          {codeToFlag(item.country_code)} {item.city}, {item.country}
                        </span>
